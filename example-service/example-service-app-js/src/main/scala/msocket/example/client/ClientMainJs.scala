...
object ClientMainJs extends ExampleCodecs {
  ...
  def main(args: Array[String]): Unit = {
    ...
    lazy val httpPostTransport =
      new HttpPostTransportJs[ExampleRequest]("http://localhost:5000/post-endpoint", CborArrayBuffer).logRequestResponse()
    ...
    lazy val rSocketTransport =
      new RSocketTransportJs[String, ExampleRequest]("ws://localhost:7000", JsonText).logRequestResponse()
