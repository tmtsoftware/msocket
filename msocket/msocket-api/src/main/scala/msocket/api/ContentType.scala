...
/**
 * This ADT captures the supported content types for the API requests The ContentType can be JSON or CBOR Both are supported for
 * serialization/deserialization by borer
 */
