 ...
 */
class WebsocketHandler[Req: ErrorProtocol](contentType: ContentType) extends StreamHandler[Req, Message] {
  override def encode[Res: Encoder](response: Res, headers: Headers): Message = contentType.strictMessage[Res](response)
}
