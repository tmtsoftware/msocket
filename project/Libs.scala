...
object Libs {
  ...
  val `borer-core`        = dep("io.bullet" %%% "borer-core" % "1.3.0")
  val `borer-derivation`  = dep("io.bullet" %%% "borer-derivation" % "1.3.0")
  val `borer-compat-akka` = "io.bullet" %% "borer-compat-akka" % "1.3.0"
